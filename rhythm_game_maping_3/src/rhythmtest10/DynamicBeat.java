...
public class DynamicBeat extends JFrame{
	...
	private Image noteRouteImage = new ImageIcon(main1.class.getResource("/images/noteRoute.png")).getImage();
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("funfun.png", "fun2.jpg", "fun1.jpg", "music1ex.mp3", "music1.mp3"));
	...
	public void screenDraw(Graphics2D g) {
		...
		if(isGameScreen) 
		{
			...
			g.drawString("Who Put the Bomp", 20, 702);
