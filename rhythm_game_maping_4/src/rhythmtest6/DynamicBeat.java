...
public class DynamicBeat extends JFrame{
	...
	private Image titleImage = new ImageIcon(main1.class.getResource("/images/funfun.png")).getImage();
	private Image selectedImage = new ImageIcon(main1.class.getResource("/images/fun2.jpg")).getImage();
	...
	startButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				buttonEnteredMusic.start();
				introMusic.close();
				Music selectedMusic = new Music("music1ex.mp3", true);
				selectedMusic.start();
