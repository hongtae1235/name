...
public class DynamicBeat extends JFrame{
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("funfun.png", "fun2.jpg", "fun1.jpg", "music1ex.mp3", "music1.mp3", "Who Put the Bomp"));
		trackList.add(new Track("newnew.png", "newyork2.jpg", "newyork1.jpg", "music3ex.mp3", "music3.mp3", "Sting(스팅) - Englishman In New York "));
		trackList.add(new Track("carcar.png", "car2.jpg", "car1.jpg", "music2ex.mp3", "music2.mp3", "Rascal Flatts - Life Is a Highway"));
	...
	public void selectedTrack(int nowSelected) {
		if(selectedMusic !=null)
			selectedMusic.close();
		titleImage = new ImageIcon(main1.class.getResource("/images/" + trackList.get(nowSelected).getTitleImage())).getImage();
	    selectedImage = new ImageIcon(main1.class.getResource("/images/" + trackList.get(nowSelected).getStartImage())).getImage();
	...
	public void gamestart(int nowSelected, String difficulty) {
		...
		easyButton.setVisible(false);
		hardButton.setVisible(false);
		Background = new ImageIcon(main1.class.getResource("/images/" + trackList.get(nowSelected).getGameImage())).getImage();
